          ...
          <ul className="navbar-nav">
            ...
            <li className="nav-item dropdown">
              ...
              <ul className="dropdown-menu">
                <li><a className="dropdown-item fs-5" href="#" onClick={(e) => handleClick(e)}>LEGOS</a></li>
                <li><hr className="dropdown-divider" /></li>
                <li><a className="dropdown-item fs-5" href="#" onClick={(e) => handleClick(e)}>TERMOS</a></li>
                <li><hr className="dropdown-divider" /></li>
                <li><a className="dropdown-item fs-5" href="#" onClick={(e) => handleClick(e)}>VASOS</a></li>
                <li><hr className="dropdown-divider" /></li>
                <li><a className="dropdown-item fs-5" href="#" onClick={(e) => handleClick(e)}>OTROS</a></li>
              </ul>
            </li>
            <li className="nav-item">
              <a className="nav-link fs-5" href="#" onClick={(e) => handClickNavBar(e, 'contact')}>Contáctanos</a>
            </li>
          </ul>
        </div>
      </div>
